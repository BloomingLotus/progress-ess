...
@XmlType(name = "ReturnMessage_Personal_Form", propOrder = {
    "message",
    "isCompleted"
})
@XmlSeeAlso({
    ReturnListObjectOfMTNationality.class,
    ReturnListObjectOfMTRace.class,
    ReturnListObjectOfMTListOfValue.class,
    ReturnListObjectOfMTBank.class,
    ReturnListObjectOfMTReasonOfResignation.class,
    ReturnListObjectOfMTResignationCategory.class,
    ReturnObjectOfListEmployeeInfoGeneralForm.class,
