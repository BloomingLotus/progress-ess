...
@XmlType(name = "ReturnMessage_Certification_Form", propOrder = {
    "message",
    "isCompleted"
})
@XmlSeeAlso({
    ReturnListObjectOfMTSkillType.class,
    ReturnListObjectOfMTCertFocusArea.class,
    ReturnListObjectOfMTCertificationInstitute.class,
    ReturnListObjectOfMTIncentiveLevel.class,
    ReturnListObjectOfInt32 .class
})
